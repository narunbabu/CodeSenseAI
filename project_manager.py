...
#         # NEW: Create a summaries directory
...
#     def update_modified_summaries(self, modified_files, summarizer):
#         # If no combined summary exists, create a new default structure.
#         if not self.combined_json_path.exists():
#             print("Warning: Combined summary file does not exist. Creating a new combined summary structure.")
#             combined = {
#                 "project_name": self.project_name,
#                 "files": {},
#                 "file_count": 0,
...
#             combined = load_json(self.combined_json_path)
#             if not combined or "files" not in combined:
#                 print("Warning: Invalid or empty combined summary file. Creating a new combined summary structure.")
#                 combined = {
#                     "project_name": self.project_name,
#                     "files": {},
#                     "file_count": 0,
...
#         for rel_path in modified_files:
#             full_path = project_path_obj / str(rel_path).replace("\\", "/")  # Normalize path
